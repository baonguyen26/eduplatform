...
// Unified imagery
const HERO_IMAGE = "/assets/primary_hero.png";

export default function Home() {
  return (
    <div className="bg-brand-bg min-h-screen text-slate-900 overflow-x-hidden">
      <Navbar />
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative z-10 space-y-8 order-2 lg:order-1 text-center lg:text-left">
            ...
            <motion.h1
              layout
              className="text-5xl md:text-7xl font-adaptive-display tracking-tight leading-[1.1] text-slate-900"
            >
              Làm chủ kiến thức <span className="text-blue-600">Cốt lõi</span>,<br />Từng bước khám phá.
            </motion.h1>
            ...
            >
              Không thi cử. Không xếp hạng. Chỉ có niềm vui thuần khiết khi hiểu rõ nền tảng kiến thức. Sơ đồ kiến thức chuyên sâu giúp xây dựng mô hình tư duy đa chiều vững chắc.
            </motion.p>
            ...
            >
              <Link
                href="/dashboard"
                className="px-8 py-4 bg-blue-600 text-white font-bold text-lg flex items-center gap-2 shadow-xl shadow-blue-200 hover:bg-blue-700 hover:scale-105 transition-all w-full sm:w-auto justify-center rounded-full"
              >
                Bắt đầu hành trình <ArrowRight className="w-5 h-5" />
              </Link>
              <button className="px-8 py-4 bg-white text-slate-600 font-bold border border-slate-200 hover:bg-slate-50 transition-all w-full sm:w-auto justify-center rounded-xl">
          ...
          <div className="relative order-1 lg:order-2">
            ...
            >
              <div className="absolute inset-0 bg-blue-600/5 blur-[120px] rounded-full scale-125" />
              <div className="relative w-full h-full overflow-hidden border-8 border-white shadow-[0_32px_64px_-16px_rgba(0,0,0,0.15)] rounded-[80px]">
                <Image
                  src={HERO_IMAGE}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="p-8 border border-slate-100 bg-slate-50/50 hover:bg-white hover:shadow-xl transition-all group rounded-[40px]"
              >
      ...
      <section id="mastery" className="py-24 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto bg-slate-900 rounded-[64px] p-12 md:p-24 relative overflow-hidden">
